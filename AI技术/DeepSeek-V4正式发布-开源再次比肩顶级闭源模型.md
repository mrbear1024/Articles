...
![DeepSeek-V4 整体架构（技术报告 Figure 2）](../images/deepseek-v4/figure2-architecture.png)
...
![CSA 核心架构（技术报告 Figure 3）](../images/deepseek-v4/figure3-csa-architecture.png)

- **Heavily Compressed Attention（HCA）**：采用更激进的压缩率（m' ≫ m），将更多 token 合并为一个条目，但保留密集注意力计算。HCA 不做稀疏选择，而是对所有压缩后的条目做完整注意力。

![HCA 核心架构（技术报告 Figure 4）](../images/deepseek-v4/figure4-hca-architecture.png)
...
![DeepSeek-V4 综合性能与效率对比（技术报告 Figure 1）](../images/deepseek-v4/figure1-performance-efficiency.png)
...
![V4-Pro-Max 与顶级模型完整对比（技术报告 Table 6）](../images/deepseek-v4/table6-frontier-comparison.png)
...
![V4 系列不同推理模式完整对比（技术报告 Table 7）](../images/deepseek-v4/table7-modes-comparison.png)
...
![推理预算与性能关系（技术报告 Figure 10）](../images/deepseek-v4/figure10-hle-terminalbench.png)

**长上下文能力**

技术报告 Figure 9 展示了 V4 系列在 MRCR 8-needle 任务上的长上下文检索能力：

![MRCR 8-needle 长上下文检索性能 + Putnam 形式推理对比（技术报告 Figure 8-9）](../images/deepseek-v4/figure8-9-putnam-mrcr.png)
...
![V4-Pro-Max vs Opus 4.6 Max 白领任务胜率与维度评分（技术报告 Figure 11-12）](../images/deepseek-v4/figure11-12-white-collar.png)
